...
function SignUp() {
    ...
    async function handleSubmit(e) {
        ...
        if (userData.password !== userData.password2) {
            setMessage({ error: "Passwords should be matched." });
            return;
        }
        ...
        try {
            ...
            if(response.ok) {
                ...
                setMessage({success: responseData?.message || 'User registration successful!'})
                // setMessage(responseData.message || 'User registration successful!')

                alert(`Dear ${userData?.username}, your registration is done successfully!`)
                navigate('/login')
            } 
            else {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="relative flex items-end px-4 pb-10 pt-60 sm:pb-16 md:justify-center lg:pb-24 bg-gray-50 sm:px-6 lg:px-8">
                ...
                <div className="relative">
                    <div className="w-full max-w-xl xl:w-full xl:mx-auto xl:pr-24 xl:max-w-xl">
                        <h3 className="text-4xl font-bold text-white">Join 50k+ users & convert your images/videos to black and white freely</h3>
                        <ul className="grid grid-cols-1 mt-10 sm:grid-cols-2 gap-x-8 gap-y-4">
                            <li className="flex items-center space-x-3">
                                ...
                                <span className="text-lg font-medium text-white"> Image processing </span>
                            </li>
                            <li className="flex items-center space-x-3">
                                <div className="inline-flex items-center justify-center flex-shrink-0 w-5 h-5 bg-blue-500 rounded-full">
                                    <svg className="w-3.5 h-3.5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <span className="text-lg font-medium text-white"> Video Processing </span>
                            </li>
                            <li className="flex items-center space-x-3">
                                <div className="inline-flex items-center justify-center flex-shrink-0 w-5 h-5 bg-blue-500 rounded-full">
                                    <svg className="w-3.5 h-3.5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <span className="text-lg font-medium text-white"> Unlimited Downloads </span>
                            </li>
                            <li className="flex items-center space-x-3">
                                <div className="inline-flex items-center justify-center flex-shrink-0 w-5 h-5 bg-blue-500 rounded-full">
                                    <svg className="w-3.5 h-3.5 text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                <div className="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                    ...
                    <p className="mt-2 text-base text-gray-600">Already have an account? <Link to={'/login'} title="Login here" className="font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 focus:text-blue-700 hover:underline">Login</Link></p>
                    ...
                    <form  onSubmit={(e) => handleSubmit(e)} className="mt-4">
                        <div className="space-y-5">
                            ...
                            <div>
                                <label htmlFor="password2" className="text-base font-medium text-gray-900">Confirm Password </label>
                                <div className="mt-2.5 relative text-gray-400 focus-within:text-gray-600">
                                    <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                                        <svg className="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path
                                    ...
                                    />
                                    {
                                        ...
                                        ?
                                        <span className="absolute left-4 -bottom-6 text-red-600">Password doesn&#39;t match.</span>
                                        : ''
                                    }
                                    {
                                        userData?.password !== '' && userData?.password === userData.password2
                                        ?
                                        <span className="absolute left-4 -bottom-6 text-green-600">Password matched.</span>
                                        : 
                                        ''
                                    }
                                </div>
                            ...
                            <div>
                                <button
                                    type="submit"
                                    className="inline-flex items-center justify-center w-full mt-6 px-4 py-4 text-base font-semibold text-white transition-all duration-200 border border-transparent rounded-md bg-gradient-to-r from-fuchsia-600 to-blue-600 focus:outline-none hover:opacity-80 focus:opacity-80"
                                >
                                    Sign up
                                </button>
                            </div>
